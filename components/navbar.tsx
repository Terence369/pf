    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 text-foreground hover:opacity-90 transition-opacity duration-300">
            <img
            ...
            />
            <span className="hidden sm:inline text-[17px] font-serif font-semibold tracking-tighter text-foreground">Pride Eventz</span>
          </Link>
